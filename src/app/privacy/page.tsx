...
export const metadata: Metadata = {
    title: "Privacy Policy | FindFanz",
    description: "FindFanz privacy policy. Learn how we collect, use, and protect your data including cookies, analytics, and third-party services.",
        ...
        <main className="legal-page">
            ...
            <section className="legal-content">
                <div className="legal-card">
                    ...
                    <p>We collect minimal information when you use FindFanz:</p>
                    <ul>
