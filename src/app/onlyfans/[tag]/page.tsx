...
function getDefaultContent(tag: string): TagContent {
  ...
  return {
    ...
    faqs: [
      ...
      { q: `Do I need an account to browse?`, a: `No. Browsing OF Directory is completely free and anonymous — no account required. When you find a creator you like, clicking their card takes you directly to their OnlyFans profile where you can subscribe.` },
    ],
  };
}
...
const TAG_CONTENT: Record<string, TagContent> = {
  free: {
    ...
    faqs: [
      ...
      { q: "Are the free OnlyFans creators on OF Directory actually free?", a: "Every creator listed on our free page has a verified $0 subscription cost on OnlyFans. We pull pricing data directly from the platform and refresh it weekly. If a creator switches to paid, they're removed from this category automatically." },
    ],
  },
  blonde: {
    ...
    intro: "Blonde creators are consistently among the most popular on OnlyFans, and for good reason. From platinum pixie cuts to sun-kissed beach waves, these creators bring a diverse range of styles and content types. OF Directory collects them all in one searchable grid with verified data so you can compare profiles, prices, and content volume without the guesswork.",
  ...
  milf: {
    ...
    intro: "MILF creators are among the fastest-growing categories on OnlyFans. These experienced women bring confidence, maturity, and a no-nonsense approach to content creation that sets them apart. OF Directory lists the top MILF accounts with verified stats so you can browse real subscriber counts, content volumes, and pricing without any guesswork.",
  ...
  "big-boobs": {
    ...
    intro: "Big boobs is one of the most popular search categories on OnlyFans. Creators in this niche attract massive subscriber bases with content that showcases their natural or enhanced assets. OF Directory lists every verified busty creator with real stats, so you can compare popularity, pricing, and content volume in seconds.",
  ...
  cosplay: {
    ...
    intro: "Cosplay OnlyFans creators transform themselves into beloved characters from anime, video games, movies, and comics. These artists combine costume design, photography, and performance into exclusive content you won't find anywhere else. OF Directory lists every verified cosplay account with real stats from the platform.",
  ...
  fitness: {
    ...
    intro: "Fitness OnlyFans creators combine incredible physiques with exclusive content that goes beyond what they can share on Instagram or YouTube. From personalised workout plans to intimate gym content, these athletes monetise their hard work on OnlyFans. OF Directory lists every fitness account with verified stats.",
  ...
  petite: {
    ...
    intro: "Petite creators punch well above their weight on OnlyFans. Small-framed women with big personalities, these creators have built massive followings with content that ranges from cute and playful to bold and intimate. OF Directory lists every verified petite account so you can compare stats and find your perfect match.",
  ...
  teen: {
    ...
    intro: "The teen category features OnlyFans creators aged 18-21 who are new to the platform and building their audiences. All creators listed are verified adults who have passed OnlyFans' age verification process. OF Directory provides real stats on these emerging profiles so you can discover rising stars before they blow up.",
  ...
  goth: {
    ...
    intro: "Goth OnlyFans creators bring a unique dark aesthetic that sets them apart from the mainstream. Black lipstick, tattoos, piercings, and moody atmospheres define this category of creators who embrace alternative beauty standards. OF Directory lists every verified goth account with real stats from the platform.",
  ...
  curvy: {
    ...
    intro: "Curvy creators celebrate their bodies with confidence and style on OnlyFans. This category showcases full-figured women who embrace their shape and have built dedicated subscriber bases doing so. OF Directory tracks them all with verified data from the platform, making it easy to find and compare curvy accounts.",
  ...
  "big-ass": {
    ...
    intro: "Big ass creators are among the fastest-growing niches on OnlyFans. From fitness queens sculpting glutes in the gym to naturally blessed beauties, this category has exploded in popularity. OF Directory shows you every verified profile with real data so you can discover top booty creators without the guesswork.",
  ...
  new: {
    ...
    intro: "The newest creators on OnlyFans are often the best discoveries. Fresh accounts mean introductory pricing, personal attention, and the thrill of finding someone before they blow up. OF Directory tracks every new verified account so you can be among their first subscribers while prices are still low.",
  ...
  popular: {
    ...
    intro: "These are the highest-subscribed OnlyFans creators across all categories. The most popular accounts on the platform have earned massive audiences through consistent quality, strong personal brands, and content that keeps subscribers coming back month after month. OF Directory ranks them by verified subscriber count, updated weekly.",
  ...
  threesome: {
    ...
    intro: "Threesome creators on OnlyFans produce some of the most exclusive, hard-to-find content on the platform. These accounts feature two or more creators collaborating on content together — whether as established groups or through guest collaborations. OF Directory lists every verified threesome account with real stats.",
