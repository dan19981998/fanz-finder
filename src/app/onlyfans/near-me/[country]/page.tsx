...
const LOCATION_CONTENT: Record<string, LocationContent> = {
    ...
    canada: {
        ...
        intro: "Canadian OnlyFans creators offer a unique blend of North American production quality with distinctly Canadian charm. From Toronto's diverse creator scene to Vancouver's fitness community to Montreal's artistic flair, Canada produces exceptional content across every niche. OF Directory lists every verified Canadian account with real platform stats.",
    ...
    colombia: {
        ...
        intro: "Colombia has emerged as one of the largest OnlyFans markets in Latin America. Colombian creators are known for their stunning beauty, confident personalities, and incredibly active posting schedules. OF Directory indexes every verified Colombian account with real stats — subscriber counts, content volumes, and transparent pricing.",
    ...
    brazil: {
        ...
        intro: "Brazil produces some of the most stunning and active OnlyFans creators on the platform. Known for their confidence, diverse beauty, and incredibly engaging personalities, Brazilian creators have built massive subscriber bases globally. OF Directory lists every verified Brazilian account with real stats from OnlyFans.",
