...
const LOCATION_CONTENT: Record<string, LocationContent> = {
    ...
    "united-kingdom": {
        ...
        intro: "The UK has one of the most active OnlyFans communities outside the US. British creators bring a distinctive style — witty, confident, and unapologetically authentic. From London glamour to northern charm, FindFanz lists every verified UK-based creator with real stats pulled directly from the platform.",
    ...
    canada: {
        ...
        intro: "Canadian OnlyFans creators offer a unique blend of North American production quality with distinctly Canadian charm. From Toronto's diverse creator scene to Vancouver's fitness community to Montreal's artistic flair, Canada produces exceptional content across every niche. FindFanz lists every verified Canadian account with real platform stats.",
    ...
    colombia: {
        ...
        intro: "Colombia has emerged as one of the largest OnlyFans markets in Latin America. Colombian creators are known for their stunning beauty, confident personalities, and incredibly active posting schedules. FindFanz indexes every verified Colombian account with real stats — subscriber counts, content volumes, and transparent pricing.",
    ...
    brazil: {
        ...
        intro: "Brazil produces some of the most stunning and active OnlyFans creators on the platform. Known for their confidence, diverse beauty, and incredibly engaging personalities, Brazilian creators have built massive subscriber bases globally. FindFanz lists every verified Brazilian account with real stats from OnlyFans.",
...
export default async function LocationPage({ params, searchParams }: Props) {
    ...
    try {
        ...
        const result = await pool.query(
            `SELECT * FROM creators WHERE country = $1 ORDER BY like_count DESC NULLS LAST LIMIT $2 OFFSET $3`,
            [loc.name, PER_PAGE, offset]
        );
